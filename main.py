...
TOKEN = "8374356501:AAGFx_JOHKFx65Hsb4MAJAkel1XNNi0MfpE"
OWNER_ID = 8199994609
# --- New Configuration ---
AUTHORIZATION_CONTACT = "@DARK_FROXT_73"
...
AUTHORIZED_GROUP_ID = -1003694167299
...
# --- GLOBAL STATE ---
user_last_command = {}
AUTHORIZED_CHATS = set((-1003694167299,))  # Add your authorized group IDs here
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    image_url = "https://i.ibb.co/4nBSMJz6/IMG-1474.png"
    try:
...
async def back_to_start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await q.message.reply_photo(
            photo="https://i.ibb.co/4nBSMJz6/IMG-1474.png", # Re-send the image
            caption=text,
            parse_mode=ParseMode.HTML,
            reply_markup=keyboard
        )
...
async def show_tools_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"{bullet_link} 𝐃𝐮𝐫𝐚𝐭𝐢𝐨𝐧  : 90 Days\n"
        f"{bullet_link} 𝐏𝐫𝐢𝐜𝐞     : 30$\n"
        "────────────────────────\n\n"
...
async def razorpay_gate_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    BULLET_GROUP_LINK = "https://t.me/+K47dLZWv3xA5NTdl"  # your clickable bullet link
    bullet_link = f"<a href='{BULLET_GROUP_LINK}'>[⌇]</a>"
...
# ===== Config =====
BULLET_GROUP_LINK = "https://t.me/+K47dLZWv3xA5NTdl"
DEVELOPER_NAME = "Froxt Atul"
DEVELOPER_LINK = "https://t.me/DARK_FROXT_73"
...
async def background_check(cc_normalized, parts, user, user_data, processing_msg):
    ...
    try:
        ...
        final_text = (
            ...
            f"</pre>\n\n"
            f"𝐃𝐄𝐕 ➵ <a href=\"tg://resolve?domain=FroxtAtul\">Froxt Atul</a>\n"                   
...
async def process_pp(update: Update, context: ContextTypes.DEFAULT_TYPE, payload: str):
    ...
    try:
        ...
        # developer branding
        DEVELOPER_NAME = "Froxt Atul"
        DEVELOPER_LINK = "https://t.me/FroxtAtul"
        developer_clickable = f'<a href="{DEVELOPER_LINK}">{DEVELOPER_NAME}</a>'
...
BULLET_GROUP_LINK = ""  # replace with your link
...
async def run_braintree_check(user, cc_input: str, full_card: str, processing_msg):
    start_time = time.time()
    developer_clickable = '<a href="https://t.me/FroxtAtul">Froxt Atul</a>'
...
async def gate_worker(update: Update, url: str, msg, user_id: int):
    ...
    developer_clickable = "[Froxt Atul](https://t.me/FroxtAtul)"
    bullet = "[⌇]"
...
async def broad(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    admin_id = 8199994609  # <-- put your Telegram user ID here
...
# Clickable bullet
BULLET_LINK = '<a href="https://t.me/+K47dLZWv3xA5NTdl">[⌇]</a>'
...
async def status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_message = (
        ...
        f"{BULLET_LINK} 𝐁𝐨𝐭 𝐁𝐲 ➳ <a href='tg://resolve?domain=FroxtAtul'>Froxt Atul</a>\n"
        "――――――――――――――――"
    )
...
def generate_congrats_box(user_id: int, plan: str, access_level: str, date: str, first_name: str) -> str:
    ...
    return (
        ...
        f"╰━━━━━━━━━━━━━━━━━━━━━━━╯\n"
        f"\n"
        f"💠 *𝕎𝕖𝕝𝕔𝕠𝕞𝕖 𝕥𝕠 𝓕𝓻𝓸𝔁𝓽𝓥𝓪𝓾𝓵𝓽𝓧* — 𝙉𝙤 𝙡𝙞𝙢𝙞𝙩𝙨 𝙅𝙪𝙨𝙩 𝙥𝙤𝙬𝙚𝙧\\.\n"
        f"𝙔𝙤𝙪’𝙧𝙚 𝙣𝙤𝙬 𝙖 𝙥𝙧𝙤𝙪𝙙 𝙢𝙚𝙢𝙗𝙚𝙧 𝙤𝙛 𝙩𝙝𝙚 *𝗘𝗹𝗶𝘁𝗲 {escape_markdown(plan, version=2)} 𝗧𝗶𝗲𝗿*\\.\n"
        f"\n"
        f"🍷 *𝓣𝓱𝓪𝓷𝓴𝓼 𝓯𝓸𝓻 𝓬𝓱𝓸𝓸𝓼𝓲𝓷𝓰 𝓕𝓻𝓸𝔁𝓽𝓥𝓪𝓾𝓵𝓽𝓧\\!* 𝙔𝙤𝙪𝙧 𝙖𝙘𝙘𝙚𝙨𝙨 𝙞𝙨 𝙣𝙤𝙬 𝙤𝙥𝙚𝙣\\."
    )
...
ADMIN_USER_ID = 8199994609  # Replace with your admin user ID
...
# 🛡️ Security
AUTHORIZED_CHATS = set([-1003694167299, -1003332800094, -1003413954160])  # Only these groups
OWNER_ID =  8199994609                    # Your Telegram user ID
...
async def block_unauthorized(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "📩 Contact @FroxtAtul to get access.\n"
        "🔗 Official group: https://t.me/+K47dLZWv3xA5NTdl"
    )
